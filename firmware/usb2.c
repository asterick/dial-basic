                                    ...
                                    app_usbd_hid_user_event_t event)
{
    ...
    switch (event) {
        ...
        case APP_USBD_HID_USER_EVT_IN_REPORT_DONE:
            app_usbd_hid_kbd_key_control(&m_app_hid_kbd2, APP_USBD_HID_KBD_A, false);
            break;
...
app_usbd_class_inst_t const *  usb_add_keyboard2() {
    kbd2 = &m_app_hid_kbd2;
    return app_usbd_hid_kbd_class_inst_get(&m_app_hid_kbd2);
}
